...
Zie hier het [Model DPIA Rijksdienst](https://www.kcbr.nl/sites/default/files/2023-09/Model%20DPIA%20Rijksdienst%20v3.0.pdf) (Model DPIA Rijksdienst). 
...
- Anonimisering van informatie is volgens de wet geen verplichting (artikel 2, lid 5 Who). De verplichtingen om gegevens voor hergebruik beschikbaar te maken, houden geen verplichting in om documenten te creëren of aan te passen of om uittreksels te verstrekken indien dit een onevenredig grote inspanning vereist die verder gaat dan een eenvoudige handeling. Als het anonimiseren van persoonsgegevens een onevenredig grote inspanning vergt, die verder gaat dan een eenvoudige handeling, dan is die niet verplicht. Indien een organisatie overweegt om persoonsgegevens beschikbaar te maken voor hergebruik, kan de organisatie doorgaans dus simpelweg besluiten om hergebruik daarvan te weigeren. De organisatie hoeft dan de gegevens niet te anonimiseren met het doel om de gegevens geschikt te maken voor hergebruik.
- Wanneer persoonsgegevens afdoende geanonimiseerd zijn volgens de AVG, dan is de AVG niet meer van toepassing. Anonimiseren vergt van dataproviders dat zij regelmatig controleren of een geanonimiseerde dataset nog afdoende is geanonimiseerd. Wanneer deze controle en het adequaat handelen bij geconstateerde gebreken daarop uitblijft is er een risico dat de dataprovider onrechtmatig persoonsgegevens aan het beschikbaar stellen is, met risico’s voor betrokkenen. Het wetsvoorstel breidt niet de verantwoordelijkheid van de dataprovider uit met een actieve zorgplicht ten aanzien van geanonimiseerde gegevens als de AVG niet meer van toepassing is. Het wetsvoorstel bevat wel een (reactieve) verplichting om een melding van een inbreuk op de voorwaarden, zoals het verbod op heridentificatie van betrokkenen, in behandeling te nemen en hierop maatregelen te nemen zoals het terugtrekken of beter beveiligen van de dataset.

In de [Memorie van Toelichting bij de Wet implementatie open data richtlijn](https://www.tweedekamer.nl/kamerstukken/detail?id=2023Z11790&did=2023D28032) (paragraaf 11.8.2) wordt uitgebreid ingegaan op het proces van anonimisering en wat er van organisaties verwacht wordt. Om te bepalen of gegevens geanonimiseerd zijn of nog een persoonsgegeven zijn, kunnen drie indicatoren worden gebruikt: 
(i)	of het mogelijk is een persoon te isoleren in een dataset (“herleidbaarheid”);
(ii)	of het mogelijk is de gegevens te koppelen aan een andere dataset (“koppelbaarheid”); en
(iii)	of het mogelijk is de waarde van een persoonskenmerk (ofwel “attribuut”) met grote waarschijnlijkheid af te leiden uit de waarden van een reeks andere attributen (“deduceerbaarheid”).

Deze indicatoren zijn contextgevoelig. Om de mogelijkheid van herleidbaarheid te bepalen is het noodzakelijk om rekening houden met: 
- Het detailniveau van de gegevens en in welke mate de verschillende categorieën gegevens potentieel identificeerbaar zijn; en
- of u over voldoende technische en organisatorische maatregelen beschikt om dit risico te beperken.

### Anonimiseringstechnieken 
Voor de koppelbaarheid zal het enkel verwijderen van de direct identificeerbare elementen uit een dataset in veel gevallen onvoldoende zijn om de gegevens effectief te anonimiseren. Er moet beoordeeld worden of geanonimiseerde gegevens gecombineerd met publiek beschikbare gegevens of via complexe statistische methoden alsnog identificeerbaar worden. 

Anonimisering vereist niet dat herleidbaarheid absoluut onmogelijk wordt gemaakt. Het is volgens overweging 26 van de AVG voldoende om rekening te houden met “alle middelen waarvan redelijkerwijs valt te verwachten dat zij worden gebruikt door de verwerkingsverantwoordelijke of door een andere persoon om de natuurlijke persoon direct of indirect te identificeren”. Hoe makkelijker, minder tijdrovend en minder kostbaar het is om een middel in te zetten, des te groter de kans dat dit middel zou kunnen worden gebruikt. Hierbij moeten technologische ontwikkelingen worden meegenomen in de afweging. Het is dus van belang een inschatting te maken van de redelijke verwachting dat anderen de middelen kunnen inzetten om gegevens weer herleidbaar te maken. 

Er zijn verschillende technieken die kunnen worden ingezet voor anonimisering. Randomisatie kan worden gebruikt om de risico’s van deduceerbaarheid te verminderen. Randomisatie wordt gerekend tot de groep technieken waarmee de waarheidsgetrouwheid van gegevens wordt gewijzigd met het doel die gegevens los te koppelen van de persoon. Als de gegevens voldoende at random zijn (dat wil zeggen willekeurig of onbepaald), is het niet langer mogelijk om ze te herleiden tot een specifieke persoon.  

Ruistoevoeging is een techniek waarbij de attributen in de dataset die belangrijke negatieve gevolgen kunnen hebben worden gewijzigd om ze minder nauwkeurig te maken.
