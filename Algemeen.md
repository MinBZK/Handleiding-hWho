...
Bij software, broncodes en bijbehorende documentatie wordt aangeraden de EUPL te gebruiken, omdat deze in samenhang moet worden beschouwd. Deze is namelijk specifiek ontwikkeld om zorgvuldig hergebruik te bevorderen. Voor hulp bij het kiezen van de juiste licentie voor software en broncodes, zie [de Licentiewijzer](https://licentiewijzer.org/question/0) voor overheden.
