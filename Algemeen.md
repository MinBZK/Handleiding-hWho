...
Bekijk [hier](#aanbev) de aanbevelingen voor het duurzamer toegankelijk maken van overheidsinformatie.
...
Het uitgangspunt van de Who en de Open data richtlijn  is dat bij terbeschikkingstelling geen of slechts de marginale verstrekkingskosten in rekening worden gebracht. Bij marginale verstrekkingskosten gaat het om de extra kosten die gemaakt moeten worden om te kunnen voldoen aan een verzoek. Eind 2017 is een [quickscan](https://vng.nl/files/vng/20171211_-_notitie_uitvoeringskosten_who_-_def.pdf) uitgevoerd naar de door gemeenten gemaakte kosten voor de uitvoering van de Who. Uit deze quickscan blijkt dat slechts een beperkt aantal verzoeken wordt ingediend en gemeenten bij de verzoekers mede daarom geen kosten in rekening brengen, ook geen marginale verstrekkingskosten. 
...
Bekijk [hier](#kosten) de regels voor de kosten per type organisatie.
...
Voor een uitgebreidere toelichting zie [hier](#aanbevbes). 
...
[Hier](#meer) vind je andere nuttige websites en publicaties. Zie onder andere de [Handleiding van Geonovum](https://docs.geostandaarden.nl/eu/handreiking-hvd/) betreffende de High Value Datasets.	
